...
function add_expense(){
    ...
    var category = selected.options[selected.selectedIndex].text;
    var category1 = selected.value;
   ...
   expense_per_category[category1]=parseInt(expense_per_category[category1])+parseInt(amount);
   update_sum();
...
function add_category()
{
    ...
    if(new_category_value){
        ...
        new_category_option.value = ++count;
